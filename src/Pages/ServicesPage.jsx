          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div
                  key={index}
                  className={`bg-gray-800/30 rounded-xl p-6 border border-gray-700 hover:border-blue-500/50 transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${selectedService === index ? 'border-blue-500' : ''
                    }`}
                ...
                >
                  ...
                  {/* Expanded Content */}
                  <div className={`mt-4 overflow-hidden transition-all duration-300 ${selectedService === index ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'
                    }`}>
